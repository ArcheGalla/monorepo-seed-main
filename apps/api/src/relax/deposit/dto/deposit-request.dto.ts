...
export class DepositRequestDto {
  ...
  @ApiProperty({
    description:
      'Total win amount, including possible jackpot win. Deposit amount as 1/100 of currency',
    example: 1000,
    required: true,
  })
  @IsNotEmpty()
  ...
  @ApiProperty({
    description: 'Transaction type for the deposit',
    enum: TxType,
    example: 'deposit',
    required: true,
  })
  ...
  @ApiProperty({
    description: 'If game round ended then true, otherwise false',
    example: true,
    required: true,
  })
  @IsNotEmpty()
  ...
  @ApiProperty({
    description: 'Promotional code set in endpoint freespins/add and freespins/add',
    example: 'PROMO123',
    required: false,
  })
  @IsOptional()
